...
int main(int argc, char ** argv) {
	...
	//Assume a 1D block
	blockX = BLOCK_DIM;		//TODO: Select the number of blocks
	blockY = 1;
    blockZ = 1;
	...
	//Assume a 1D grid
	gridX = M/blockX + (M%blockX>0); 	//TODO: Select the number of blocks
	printf("gridx:%d\n", gridX);
	gridY = 1; 
	gridZ = 1;
	...
	//TODO - Question 1: Copy the result from "dev_b" back to the CPU in "b"
		...
		cudaMemcpy((void*)b,(void*)dev_b,M*sizeof(float), cudaMemcpyDeviceToHost);
	//----
